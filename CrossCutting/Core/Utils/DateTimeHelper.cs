...
namespace CrossCutting.Core.Utils
{
    ...
    using CrossCutting.Core.ViewModels;
    #region
    ...
    public static class DateTimeHelper
    {
        ...
        /// The days in english.
        /// </summary>
        public static string[] DaysInEnglish =>
        ...
        public static string GetCurrentUmAlQuraDateString(DateTime date, string dateFormat = "dd/MM/yyyy")
        {
            ...
            if (IsUmAlqura(date.ToString(dateFormat, CultureInfo.InvariantCulture)))
...
#pragma warning restore S108 // Nested blocks of code should not be left empty
        ...
        public static string GetGregoreanDateString(DateTime date, string dateFormat = "dd/MM/yyyy")
        {
            ...
            if (IsGregorian(date.ToString(dateFormat, CultureInfo.InvariantCulture)))
                return date.ToString(dateFormat, CultureInfo.InvariantCulture);
        ...
        public static List<DayViewModel> GetDays()
        {
            List<DayViewModel> days;

            if (CultureHelper.IsArabic)
                days = CollectDays(DaysInArabic);
            else
                days = CollectDays(DaysInEnglish);
        ...
        private static List<DayViewModel> CollectDays(string[] daysNames)
        {
        ...
        /// <summary>
        /// Date string format must be dd/MM/yyyy
        /// </summary>
        /// <param name="dateString"></param>
        /// <returns></returns>
        public static string FixUmAlquraDateString(this string dateString)
        {
            try
            {
                ...
                {
                    if (dateString.StartsWith("30"))
                        return dateString.Replace("30", "29");
                }
